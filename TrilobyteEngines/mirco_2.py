...
def find_best_move_mp(board, depth, maximizing_player):
    ...
    return_list[0].sort(key=lambda x: x[0])
    return "".join(str(item) + "\n" for item in return_list[0])


if __name__ == "__main__":            
    blues = [(1,1), (2,2), (3,2), (2,3), (3,3), (0,5), (0,6), (4,6)]
    greens = [(6,1), (4,2), (5,2), (4,3)]    
    ...
    seed_tested = False
    if seed_tested:
        execute((False, 6, 5), board, True)
        execute((False, 5, 0), board, False)
        execute((False, 6, 4), board, True)
        execute((False, 6, 1), board, False)
        execute((False, 5, 6), board, True)
        execute((False, 5, 1), board, False)
        execute((False, 6, 3), board, True)
        execute((False, 0, 5), board, False)
        execute((False, 6, 2), board, True)
        execute((True, 5, 2, 5, 0), board, False)
        execute((False, 5, 3), board, True)
        execute((False, 5, 0), board, False)
        execute((False, 5, 5), board, True)
        execute((False, 1, 6), board, False)
        execute((False, 5, 4), board, True)
        execute((False, 1, 5), board, False)
        execute((False, 4, 6), board, True)
        execute((False, 0, 4), board, False)
        execute((False, 4, 5), board, True)
        execute((True, 3, 4, 1, 5), board, False)
        execute((False, 3, 5), board, True)
        execute((False, 2, 5), board, False)
        execute((True, 2, 4, 4, 6), board, True)
        execute((True, 3, 6, 1, 6), board, False)
        execute((True, 1, 5, 3, 4), board, True)
        execute((True, 1, 4, 3, 5), board, False)
        execute((False, 1, 6), board, True)
        execute((False, 4, 4), board, False)
        execute((False, 4, 3), board, True)
        execute((False, 2, 6), board, False)
        execute((False, 4, 6), board, True)
        execute((True, 4, 2, 5, 0), board, False)
        execute((True, 5, 0, 6, 2), board, True)
        execute((False, 6, 2), board, False)
        execute((False, 4, 1), board, True)
        execute((False, 3, 5), board, False)
        execute((True, 3, 4, 5, 2), board, True)
        execute((False, 5, 2), board, False)
        execute((False, 4, 0), board, True)
        execute((False, 3, 1), board, False)
        execute((False, 1, 3), board, True)
        execute((True, 2, 3, 3, 1), board, False)
        execute((False, 3, 3), board, True)
        execute((True, 3, 2, 1, 3), board, False)
        execute((False, 1, 3), board, True)
        execute((False, 2, 2), board, False)
        execute((True, 1, 2, 0, 0), board, True)
        execute((False, 2, 1), board, False)
        execute((True, 3, 1, 5, 0), board, True)
        execute((False, 5, 0), board, False)
        execute((False, 1, 1), board, True)
        execute((False, 3, 0), board, False)
        execute((False, 2, 0), board, True)
        execute((True, 0 , 3, 1, 5), board, False)
        execute((False, 1, 5), board, True)
        execute((False, 0, 2), board, False)
        # Strategy change, depth to 7, gives winning sequence, from the 10.5 duplication instead of 14.5 jump
        execute((False, 1, 0), board, True)
        execute((False, 0, 1), board, False)
        execute((True, 0, 0, 2, 2), board, True)
    # dxn + jump
    execute((True, 5, 3, 3, 3), board, True)
    execute((True, 4, 1, 6, 1), board, False)
    
    printb(board)
    print(find_best_move_mp(board, 5, True))